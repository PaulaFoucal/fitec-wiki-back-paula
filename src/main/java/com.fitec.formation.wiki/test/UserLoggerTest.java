...
public class UserLoggerTest {
    ...
    public List<UserLogger> initUserLoggerSuite() {
        ...
        ul01.setCreationDate(utils.createDate("01-01-2011"));
        ...
        ul02.setCreationDate(utils.createDate("02-02-2012"));
        ...
        ul03.setCreationDate(utils.createDate("03-03-2013"));
        ul03.setProfile(profileTest.initProfileSuite().get(2));
        usersLogger.add(ul03);

        System.out.println("Inside UserLoggerTest");
